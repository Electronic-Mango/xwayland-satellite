...
fn xsettings_scale() {
    ...
    assert_eq!(settings.data["Gtk/CursorThemeSize"].value, 24);
    let cursor_serial = settings.data["Gtk/CursorThemeSize"].last_change;
    ...
    assert_eq!(settings.data["Gtk/CursorThemeSize"].value, 2 * 24);
    assert!(settings.data["Gtk/CursorThemeSize"].last_change > cursor_serial);
...
fn xsettings_fractional_scale() {
    ...
    assert_eq!(
        settings.data["Gtk/CursorThemeSize"].value,
